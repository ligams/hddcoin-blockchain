...
This repo includes the code for the Chia full node, farmer, and timelord (in hddcoin folder), which are all written in python.
...
If you want to learn more about this project, read the [wiki](https://github.com/Chia-Network/hddcoin-blockchain/wiki), or check out the [green paper](https://www.hddcoin.org/assets/ChiaGreenPaper.pdf).
...
As we have now released, the main priority is improving the mainnet blockchain. You can view our [Product Roadmap](https://roadmap.hddcoin.org) to see what we are working on.

If you are interested in cryptography, math, or just like hacking in python, there are many interesting problems to work on.
Contact any of the team members on [Discord](https://discord.gg/hddcoin), which we use as the main communication method.
...
sh install.sh -d
. ./activate
black . && isort benchmarks build_scripts hddcoin tests tools *.py && mypy && flake8 benchmarks build_scripts hddcoin tests tools *.py && pylint benchmarks build_scripts hddcoin tests tools *.py
...
We provide a [pre-commit configuration](https://github.com/Chia-Network/hddcoin-blockchain/blob/main/.pre-commit-config.yaml) which triggers several useful
...
The current official testnet is testnet10. Look at `hddcoin/util/initial_config.yaml` to see the configuration parameters
