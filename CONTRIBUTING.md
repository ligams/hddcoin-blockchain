...
In the event an emergency fix is required for the release version of HDDcoin, members of the HDDcoin organization will create a feature branch from the current release branch `latest`.
