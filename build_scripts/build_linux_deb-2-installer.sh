...
export HDDCOIN_INSTALLER_VERSION
...
pip install j2cli
CLI_DEB_BASE="hddcoin-blockchain-cli_$HDDCOIN_INSTALLER_VERSION-1_$PLATFORM"
mkdir -p "dist/$CLI_DEB_BASE/opt/hddcoin"
mkdir -p "dist/$CLI_DEB_BASE/usr/bin"
mkdir -p "dist/$CLI_DEB_BASE/DEBIAN"
j2 -o "dist/$CLI_DEB_BASE/DEBIAN/control" assets/deb/control.j2
cp -r dist/daemon/* "dist/$CLI_DEB_BASE/opt/hddcoin/"
ln -s ../../opt/hddcoin/hddcoin "dist/$CLI_DEB_BASE/usr/bin/hddcoin"
...
if [ "$PLATFORM" = "arm64" ]; then
  ...
  echo USE_SYSTEM_FPM=true electron-builder build --linux deb --arm64 \
    ...
    --config.deb.packageName="hddcoin-blockchain"
...
GUI_DEB_NAME=hddcoin-blockchain_${HDDCOIN_INSTALLER_VERSION}_${PLATFORM}.deb
mv "dist/${PRODUCT_NAME}-${HDDCOIN_INSTALLER_VERSION}.deb" "../../../build_scripts/dist/${GUI_DEB_NAME}"
