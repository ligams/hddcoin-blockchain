...
Write-Output "Remove unused @hddcoin-network packages to make cache slim"
...
# Remove `packages/gui/node_modules/@hddcoin-network` because it causes an error on later `electron-packager` command
Remove-Item "@hddcoin-network" -Recurse -Force
