...
if [ "$(uname -m)" = "armv7l" ]; then
  ...
  echo "https://github.com/Chia-Network/hddcoin-blockchain/wiki/Raspberry-Pi"
  echo "Exiting."
  exit 1
fi
# Get submodules
...
install_python3_and_sqlite3_from_source_with_yum() {
  ...
  cd "$TMP_PATH"
  # Install sqlite>=3.37
  # yum install sqlite-devel brings sqlite3.7 which is not compatible with hddcoin
  ...
  # yum install python3 brings Python3.6 which is not supported by hddcoin
  cd ..
...
echo "https://discord.gg/hddcoin"
echo ""
echo "Try the Quick Start Guide to running hddcoin-blockchain:"
echo "https://github.com/Chia-Network/hddcoin-blockchain/wiki/Quick-Start-Guide"
echo ""
