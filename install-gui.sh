...
# https://github.com/HDDcoin-Network/hddcoin-blockchain/pull/10460#issuecomment-1054492495
...
if [ ! "$CI" ]; then
  ...
  # Set modified output of `hddcoin version` to version property of GUI's package.json
