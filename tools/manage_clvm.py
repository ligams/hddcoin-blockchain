...
root = here.parent
cache_path = root.joinpath(".hddcoin_cache", "manage_clvm.json")
...
from hddcoin.types.blockchain_format.serialized_program import SerializedProgram  # noqa: E402
...
top_levels = {"hddcoin"}
hashes_path = root.joinpath("hddcoin/wallet/puzzles/deployed_puzzle_hashes.json")
std_libraries = root.joinpath("hddcoin/wallet/puzzles")
...
main(auto_envvar_prefix="HDDCOIN_MANAGE_CLVM")
