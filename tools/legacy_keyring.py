"""
Provides a helper to access the legacy keyring which was supported up to version 1.6.1 of hddcoin-blockchain. To use this
...
from hddcoin.util.errors import KeychainUserNotFound
from hddcoin.util.keychain import KeyData, KeyDataSecrets, get_private_key_user
