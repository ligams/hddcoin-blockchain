...
def test_base_event_loop_has_methods() -> None:
    ...
    Moreover, this checks our internal method `_hddcoin_create_server` doesn't change signature and that our
    ...
    try:
        ...
        assert inspect.isfunction(_hddcoin_create_server)
        ...
        assert str(inspect.signature(_hddcoin_create_server)) == expected_signature
        ...
        def in_thread() -> None:
            ...
            set_hddcoin_policy(connection_limit=0)
            asyncio.run(main())
