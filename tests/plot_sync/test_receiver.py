...
from hddcoin.plot_sync.receiver import Receiver, Sync
from hddcoin.plot_sync.util import ErrorCodes, State
from hddcoin.plotting.util import HarvestingMode
...
def assert_error_response(plot_sync: Receiver, error_code: ErrorCodes) -> None:
    ...
    # WSHDDcoinConnection doesn't have last_sent_message its part of the WSHDDcoinConnectionDummy class used for testing
