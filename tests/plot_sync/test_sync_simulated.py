...
from hddcoin.plotting.util import PlotInfo
from hddcoin.protocols.harvester_protocol import PlotSyncError, PlotSyncResponse
...
from hddcoin.util.ints import int16, uint8, uint64
...
async def skip_processing(self: Any, _: WSHDDcoinConnection, message_type: ProtocolMessageTypes, message: Any) -> bool:
...
async def _testable_process(
    self: Any, peer: WSHDDcoinConnection, message_type: ProtocolMessageTypes, message: Any
) -> None:
