...
from hddcoin.cmds.check_wallet_db import DerivationPath, Wallet, check_addresses_used_contiguous, check_for_gaps
...
def test_wallet_db_type_invalid() -> None:
    """
    Test that we can construct hddcoin.cmds.check_wallet_db.Wallet with an invalid wallet_type.
