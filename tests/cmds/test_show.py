...
from hddcoin.types.blockchain_format.foliage import FoliageTransactionBlock
...
def test_hddcoin_show(capsys: object, get_test_cli_clients: Tuple[TestRpcClients, Path]) -> None:
    ...
    assert_list = [
        ...
        "Block fees: 500000000000 bytes",
        "Fee rate:    3.077e+04 bytes per CLVM cost",
