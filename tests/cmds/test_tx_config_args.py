...
from hddcoin.cmds.cmds_util import CMDCoinSelectionConfigLoader, CMDTXConfigLoader, coin_selection_args, tx_config_args
from hddcoin.util.config import create_default_hddcoin_config, load_config
...
def test_tx_config_args() -> None:
    ...
    with runner.isolated_filesystem():
        create_default_hddcoin_config(Path("."))
