...
from hddcoin.cmds.farm_funcs import summary
...
from hddcoin.types.aliases import FarmerService, HarvesterService, SimulatorFullNodeService, WalletService
...
async def test_farm_summary_command(
    ...
    assert "Total hddcoin farmed:" in lines[1]
