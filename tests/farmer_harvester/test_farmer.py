...
from hddcoin.protocols.harvester_protocol import NewProofOfSpace, RespondSignatures
from hddcoin.protocols.pool_protocol import PoolErrorCode
...
async def test_farmer_pool_response(
    ...
    peer = cast(WSHDDcoinConnection, DummyHarvesterPeer(False))
    await farmer_api.new_proof_of_space(new_pos, peer)
