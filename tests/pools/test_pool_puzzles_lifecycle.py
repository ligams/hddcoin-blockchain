...
from hddcoin.wallet.singleton import get_most_recent_singleton_coin_from_coin_spend
...
This test suite aims to test:
    ...
    - hddcoin.wallet.puzzles.pool_member_innerpuz.clsp
    - hddcoin.wallet.puzzles.pool_waiting_room_innerpuz.clsp
"""
