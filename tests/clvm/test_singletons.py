...
from hddcoin.clvm.spend_sim import CostLogger, SimClient, SpendSim, sim_and_client
...
from hddcoin.wallet.puzzles import p2_conditions, p2_delegated_puzzle_or_hidden_puzzle
...
This test suite aims to test:
    ...
    - hddcoin.wallet.puzzles.singleton_top_layer.clsp
    - hddcoin.wallet.puzzles.singleton_top_layer_v1_1.py
    - hddcoin.wallet.puzzles.singleton_top_layer_v1_1.clsp
    - hddcoin.wallet.puzzles.p2_singleton.clsp
    - hddcoin.wallet.puzzles.p2_singleton_or_delayed_puzhash.clsp
"""
...
async def test_singleton_top_layer(version, cost_logger):
    async with sim_and_client() as (sim, sim_client):
        ...
        if version == 0:
            ...
            from hddcoin.wallet.puzzles import singleton_top_layer_v1_1 as singleton_top_layer
