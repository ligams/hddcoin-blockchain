...
from hddcoin.clvm.spend_sim import SimClient, SpendSim, sim_and_client
...
from hddcoin.wallet.cat_wallet.cat_utils import CAT_MOD
from hddcoin.wallet.dao_wallet.dao_info import DAORules
from hddcoin.wallet.dao_wallet.dao_utils import curry_singleton, get_p2_singleton_puzhash, get_treasury_puzzle
from hddcoin.wallet.puzzles.load_clvm import load_clvm
from hddcoin.wallet.singleton import create_singleton_puzzle_hash
...
def test_spend_p2_singleton() -> None:
    ...
    # Solution Values
    hdd_parent_amt_list = [[b"x" * 32, 10], [b"y" * 32, 100]]
    cat_parent_amt_list = [
    ...
    # Solution
    spend_p2_sol = Program.to([hdd_parent_amt_list, cat_parent_amt_list, treasury_inner_puzhash])
