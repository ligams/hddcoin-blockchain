...
from hddcoin.wallet.util.query_filter import AmountFilter, HashFilter
...
from hddcoin.wallet.wallet_coin_store import CoinRecordOrder, GetCoinRecords, GetCoinRecordsResult, WalletCoinStore
