...
from hddcoin.wallet.cat_wallet.cat_utils import CAT_MOD, construct_cat_puzzle
from hddcoin.wallet.cat_wallet.cat_wallet import CATWallet
from hddcoin.wallet.conditions import ConditionValidTimes, Remark
...
async def test_cat_endpoints(wallet_rpc_environment: WalletRpcTestEnvironment):
    ...
    # Creates a CAT wallet with 100 bytes and a CAT with 20 bytes and fee=10
...
async def test_get_balances(wallet_rpc_environment: WalletRpcTestEnvironment):
    ...
    await time_out_assert(20, client.get_synced)
    # Creates a CAT wallet with 100 bytes and a CAT with 20 mojos
