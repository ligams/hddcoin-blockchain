...
from hddcoin.types.blockchain_format.coin import coin_as_list
...
from hddcoin.wallet.vc_wallet.cr_cat_drivers import ProofsChecker, construct_cr_layer
from hddcoin.wallet.vc_wallet.cr_cat_wallet import CRCATWallet
from hddcoin.wallet.vc_wallet.vc_store import VCProofs, VCRecord
...
async def test_vc_lifecycle(wallet_environments: WalletTestFramework) -> None:
    ...
    wallet_0 = wallet_environments.environments[0].hdd_wallet
    wallet_1 = wallet_environments.environments[1].hdd_wallet
