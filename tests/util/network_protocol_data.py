...
from hddcoin.protocols.shared_protocol import Error
...
from hddcoin.types.weight_proof import RecentChainData, SubEpochChallengeSegment, SubEpochData, SubSlotData, WeightProof
from hddcoin.util.errors import Err
from hddcoin.util.ints import int16, uint8, uint16, uint32, uint64, uint128
