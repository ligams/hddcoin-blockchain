...
from hddcoin.simulator.block_tools import BlockTools, create_block_tools_async
...
OldSimulatorsAndWallets = Tuple[List[FullNodeSimulator], List[Tuple[WalletNode, HDDcoinServer]], BlockTools]
...
) -> AsyncIterator[Tuple[FullNodeAPI, FullNodeAPI, HDDcoinServer, HDDcoinServer, BlockTools]]:
    """
