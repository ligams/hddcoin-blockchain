...
@contextlib.contextmanager
def closing_hddcoin_root_popen(hddcoin_root: HDDcoinRoot, args: List[str]) -> Iterator[subprocess.Popen[Any]]:
    environment = {**os.environ, "HDDCOIN_ROOT": os.fspath(hddcoin_root.path)}
