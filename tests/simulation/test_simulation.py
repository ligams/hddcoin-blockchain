...
class TestSimulation:
    ...
    async def test_full_system(self, simulation, extra_node, self_hostname):
        ...
        server1: HDDcoinServer = full_system.node_1._server
        ...
        server3: HDDcoinServer = node3.full_node.server
        ...
        await time_out_assert(60, verify_daemon_connection, True, full_system.daemon, "hddcoin_full_node")
