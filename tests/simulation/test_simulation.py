...
from hddcoin.simulator.setup_nodes import SimulatorsAndWallets, setup_full_system, setup_simulators_and_wallets
...
class TestSimulation:
    ...
    async def test_simulation_1(self, simulation, extra_node, self_hostname):
        ...
        server1: HDDcoinServer = node1.full_node.server
    ...
    @pytest.mark.parametrize(
        argnames="amounts",
        argvalues=[
            *[pytest.param([uint64(1)] * n, id=f"1 byte x {n}") for n in [0, 1, 10, 49, 51, 103]],
            *[
