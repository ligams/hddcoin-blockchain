...
class Crawler:
    ...
    async def connect_task(self, peer):
        async def peer_action(peer: WSHDDcoinConnection):
    ...
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: WSHDDcoinConnection):
        try:
            peer_info = peer.get_peer_info()
    ...
    async def on_connect(self, connection: WSHDDcoinConnection):
        pass
