...
from hddcoin.protocols.full_node_protocol import RespondPeers
from hddcoin.rpc.rpc_server import StateChangedProtocol, default_get_connections
from hddcoin.seeder.crawl_store import CrawlStore
from hddcoin.seeder.peer_record import PeerRecord, PeerReliability
...
class Crawler:
    ...
    async def create_client(
        self, peer_info: PeerInfo, on_connect: Callable[[WSHDDcoinConnection], Awaitable[None]]
    ) -> bool:
    ...
    async def connect_task(self, peer: PeerRecord) -> None:
        ...
        async def peer_action(peer: WSHDDcoinConnection) -> None:
