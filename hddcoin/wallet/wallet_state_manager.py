...
from hddcoin.wallet.cat_wallet.cat_utils import construct_cat_puzzle, match_cat_puzzle
...
from hddcoin.wallet.did_wallet.did_wallet_puzzles import DID_INNERPUZ_MOD, create_fullpuz, match_did_puzzle
from hddcoin.wallet.key_val_store import KeyValStore
from hddcoin.wallet.nft_wallet.nft_info import NFTWalletInfo
...
from hddcoin.wallet.puzzles.cat_loader import CAT_MOD, CAT_MOD_HASH
...
from hddcoin.wallet.util.wallet_sync_utils import PeerRequestException, last_change_height_cs
...
class WalletStateManager:
    ...
    async def filter_spam(self, new_coin_state: List[CoinState]) -> List[CoinState]:
        ...
        # No need to filter anything if the filter is set to 1 or 0 bytes
