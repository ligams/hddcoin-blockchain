...
recompile_requested = (
    (os.environ.get("HDDCOIN_DEV_COMPILE_CLVM_ON_IMPORT", "") != "") or ("pytest" in sys.modules)
) and os.environ.get("HDDCOIN_DEV_COMPILE_CLVM_DISABLED", None) is None
            ...
            if pkg_resources.resource_exists(package_or_requirement, clvm_filename):
                ...
                if not output.exists() or os.stat(full_path).st_mtime > os.stat(output).st_mtime:
                    ...
                    if include_standard_libraries:
                        ...
                        hddcoin_puzzles_path = pathlib.Path(
