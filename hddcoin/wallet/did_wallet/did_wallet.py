...
from hddcoin.wallet.did_wallet.did_wallet_puzzles import match_did_puzzle, uncurry_innerpuz
...
class DIDWallet:
    ...
    async def coin_added(self, coin: Coin, _: uint32, peer: WSHDDcoinConnection, parent_coin_data: Optional[DIDCoinData]):
    ...
    async def create_update_spend(
        ...
        if hddcoin_tx is not None and hddcoin_tx.spend_bundle is not None:
            ...
            await self.wallet_state_manager.add_pending_transaction(hddcoin_tx)
