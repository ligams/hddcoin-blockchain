...
from hddcoin.util.chunks import chunks
...
class WalletNode:
    ...
    def on_disconnect(self, peer: WSHDDcoinConnection) -> None:
    ...
    async def is_peer_synced(self, peer: WSHDDcoinConnection, height: uint32) -> Optional[uint64]:
        # Get last timestamp
