...
from hddcoin.protocols.harvester_protocol import Plot, PlotSyncResponse
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSHDDcoinConnection
    ) -> None:
        """
