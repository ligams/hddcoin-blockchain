...
from hddcoin.cmds.init_funcs import init
...
from hddcoin.protocols.shared_protocol import Capability, capabilities
from hddcoin.seeder.dns_server import DNSServer, create_dns_server_service
from hddcoin.seeder.start_crawler import create_full_node_crawler_service
from hddcoin.server.outbound_message import NodeType
from hddcoin.server.start_farmer import create_farmer_service
from hddcoin.server.start_full_node import create_full_node_service
from hddcoin.server.start_harvester import create_harvester_service
from hddcoin.server.start_introducer import create_introducer_service
from hddcoin.server.start_timelord import create_timelord_service
...
from hddcoin.simulator.ssl_certs import get_next_nodes_certs_and_keys, get_next_private_ca_cert_and_key
from hddcoin.simulator.start_simulator import create_full_node_simulator_service
from hddcoin.ssl.create_ssl import create_all_ssl
from hddcoin.timelord.timelord_launcher import VDFClientProcessMgr, find_vdf_client, spawn_process
...
from hddcoin.util.config import config_path_for_filename, load_config, lock_and_load_config, save_config, set_peer_info
...
async def setup_crawler(
    ...
    service_config["other_peers_port"] = 38444
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["hdd_spam_amount"] = hdd_spam_amount
...
async def setup_farmer(
    ...
    service_config["hdd_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "xch")
