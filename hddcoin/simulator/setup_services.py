...
from hddcoin.util.config import config_path_for_filename, lock_and_load_config, save_config
...
async def setup_farmer(
    ...
    service_config["hdd_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "hdd")
