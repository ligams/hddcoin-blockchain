...
from hddcoin.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
...
class Sender:
    ...
    _connection: Optional[WSHDDcoinConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSHDDcoinConnection) -> None:
