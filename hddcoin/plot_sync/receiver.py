...
from hddcoin.plot_sync.exceptions import (
...
from hddcoin.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
...
from hddcoin.util.ints import int16, uint32, uint64
...
class Receiver:
    _connection: WSHDDcoinConnection
    _current_sync: Sync
    _last_sync: Sync
    ...
    def connection(self) -> WSHDDcoinConnection:
