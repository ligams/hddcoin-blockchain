...
from hddcoin.full_node.fee_estimate import FeeEstimate, FeeEstimateGroup, FeeEstimateV2, fee_estimate_v2_to_v1
from hddcoin.full_node.fee_estimation import FeeMempoolInfo
from hddcoin.full_node.fee_tracker import (
    BucketResult,
    EstimateResult,
    FeeTracker,
    get_bucket_index,
...
class SmartFeeEstimator:
    ...
    def estimate_result_to_fee_estimate(self, r: EstimateResult) -> FeeEstimateV2:
        ...
        if fee == -1:
            ...
            # convert from byte / 1000 clvm_cost to byte / 1 clvm_cost
