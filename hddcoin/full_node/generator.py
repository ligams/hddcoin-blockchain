...
from hddcoin.types.generator_types import BlockGenerator, CompressorArg, GeneratorBlockCacheInterface
...
DECOMPRESS_BLOCK = load_clvm_maybe_recompile("block_program_zero.clvm", package_or_requirement="hddcoin.wallet.puzzles")
DECOMPRESS_PUZZLE = load_clvm_maybe_recompile("decompress_puzzle.clvm", package_or_requirement="hddcoin.wallet.puzzles")
