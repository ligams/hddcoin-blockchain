...
from hddcoin.full_node.fee_estimation import FeeMempoolInfo, MempoolInfo
...
class Mempool:
    def __init__(self, mempool_info: MempoolInfo, fee_estimator: FeeEstimatorInterface):
        ...
        self.total_mempool_fees: Bytes = Bytes(uint64(0))
    ...
    def remove_from_pool(self, items: List[bytes32], reason: MempoolRemoveReason) -> None:
        ...
        for spend_bundle_id in items:
            ...
            self.total_mempool_fees = Bytes(uint64(self.total_mempool_fees - item.fee))
