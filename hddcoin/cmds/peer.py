...
from hddcoin.cmds.cmds_util import NODE_TYPES
from hddcoin.cmds.peer_funcs import peer_async
...
@click.option("-a", "--add-connection", help="Connect specified HDDcoin service to ip:port", type=str, default="")
@click.option(
