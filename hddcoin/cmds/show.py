...
def show_cmd(
    ...
    if connections:
        print("'hddcoin show -c' has been renamed to 'hddcoin peer -c' ")
    if add_connection != "":
        print("'hddcoin show -a' has been renamed to 'hddcoin peer -a' ")
    if remove_connection != "":
        print("'hddcoin show -r' has been renamed to 'hddcoin peer -r' ")
