...
def create_data_store(
    ...
    from hddcoin.cmds.data_funcs import create_data_store_cmd
...
def get_value(
    ...
    from hddcoin.cmds.data_funcs import get_value_cmd
...
def update_data_store(
    ...
    from hddcoin.cmds.data_funcs import update_data_store_cmd
...
def get_keys(
    ...
    from hddcoin.cmds.data_funcs import get_keys_cmd
...
def get_keys_values(
    ...
    from hddcoin.cmds.data_funcs import get_keys_values_cmd
...
def get_root(
    ...
    from hddcoin.cmds.data_funcs import get_root_cmd
...
def subscribe(
    ...
    from hddcoin.cmds.data_funcs import subscribe_cmd
...
def remove_subscription(
    ...
    from hddcoin.cmds.data_funcs import remove_subscriptions_cmd
...
def unsubscribe(
    ...
    from hddcoin.cmds.data_funcs import unsubscribe_cmd
...
def get_kv_diff(
    ...
    from hddcoin.cmds.data_funcs import get_kv_diff_cmd
...
def get_root_history(
    ...
    from hddcoin.cmds.data_funcs import get_root_history_cmd
...
def add_missing_files(
    ...
    from hddcoin.cmds.data_funcs import add_missing_files_cmd
...
def add_mirror(
    ...
    from hddcoin.cmds.data_funcs import add_mirror_cmd
...
def delete_mirror(
    ...
    from hddcoin.cmds.data_funcs import delete_mirror_cmd
...
def get_mirrors(
    ...
    from hddcoin.cmds.data_funcs import get_mirrors_cmd
...
def get_subscriptions(
    ...
    from hddcoin.cmds.data_funcs import get_subscriptions_cmd
...
def get_owned_stores(
    ...
    from hddcoin.cmds.data_funcs import get_owned_stores_cmd
...
def get_sync_status(
    ...
    from hddcoin.cmds.data_funcs import get_sync_status_cmd
...
def check_plugins(
    ...
    from hddcoin.cmds.data_funcs import check_plugins_cmd
...
def clear_pending_roots(
    ...
    from hddcoin.cmds.data_funcs import clear_pending_roots
...
def wallet_log_in(
    ...
    from hddcoin.cmds.data_funcs import wallet_log_in_cmd
