...
def generate(shell: str) -> None:
    ...
    You can source it directly (performs slower) by running:
        \033[3;33meval "$(hddcoin complete generate)"\033[0m
    or you can save the output to a file:
        \033[3;33mhddcoin complete generate > ~/.hddcoin-complete-bash\033[0m
    and source that file with:
        \033[3;33m. ~/.hddcoin-complete-bash\033[0m
    """
    ...
    subprocess.run(["hddcoin"], check=True, env={**os.environ, "_HDDCOIN_COMPLETE": f"{shell}_source"})
