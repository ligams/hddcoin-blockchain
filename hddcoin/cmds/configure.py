...
from hddcoin.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "38444"
                testnet_introducer = "introducer-testnet.hddcoin.org"
                testnet_dns_introducer = "dns-introducer-testnet.hddcoin.org"
                bootstrap_peers = ["node-testnet.hddcoin.org"]
                testnet = "testnet"
                ...
                bootstrap_peers = ["node.hddcoin.org"]
                net = "mainnet"
