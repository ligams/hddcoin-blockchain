...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older HDDcoin versions use "
...
@click.option("--prefix", "-x", help="Address prefix (hdd for mainnet, thdd for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
