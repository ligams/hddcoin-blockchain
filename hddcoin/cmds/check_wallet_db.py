...
from hddcoin.util.collection import find_duplicates
from hddcoin.util.db_synchronous import db_synchronous_on
from hddcoin.util.db_wrapper import DBWrapper2, execute_fetchone
from hddcoin.util.pprint import print_compact_ranges
...
help_text = """
\b
    The purpose of this command is find potential issues in HDDcoin wallet databases.
    The core hddcoin client currently uses sqlite to store the wallet databases, one database per key.
\b
