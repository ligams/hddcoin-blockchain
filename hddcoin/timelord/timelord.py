...
from hddcoin.types.blockchain_format.vdf import VDFInfo, VDFProof, validate_vdf
from hddcoin.types.end_of_slot_bundle import EndOfSubSlotBundle
from hddcoin.util.config import process_config_start_method
...
class Timelord:
    ...
    def __init__(self, root_path: Path, config: Dict[str, Any], constants: ConsensusConstants) -> None:
        ...
        self._server: Optional[HDDcoinServer] = None
