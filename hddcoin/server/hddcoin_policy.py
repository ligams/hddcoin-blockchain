...
if sys.platform == "win32":
    ...
    class HDDcoinProactor(asyncio.windows_events.IocpProactor):
        ...
        async def _hddcoin_accept_loop(self, listener):
            while True:
        ...
        def _hddcoin_accept(self, listener):
    ...
    class HDDcoinProactorEventLoop(asyncio.windows_events.ProactorEventLoop):
