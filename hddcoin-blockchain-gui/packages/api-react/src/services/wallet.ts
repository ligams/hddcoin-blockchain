...
import { CAT, DID, Farmer, NFT, Pool, WalletService, WalletType, toBech32m, VC } from '@hddcoin-network/api';
import type { NFTInfo, Transaction, Wallet, WalletBalance } from '@hddcoin-network/api';
