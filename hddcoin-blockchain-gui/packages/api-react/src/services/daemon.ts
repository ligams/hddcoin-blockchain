import { Daemon, optionsForPlotter, defaultsForPlotter, PlotterName } from '@hddcoin-network/api';
import type { Plotter, PlotterMap, PlotterApi } from '@hddcoin-network/api';
