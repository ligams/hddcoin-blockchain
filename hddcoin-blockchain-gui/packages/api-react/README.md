# hddcoin-blockchain-gui/api-react
...
This library provides react hooks on the top of @hddcoin-network/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under the hood.
...
import { useGetPublicKeysQuery } from '@hddcoin-network/api-react';
...
import { store, api } from '@hddcoin-network/api-react';
