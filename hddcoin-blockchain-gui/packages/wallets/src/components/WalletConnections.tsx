import { Connection, ServiceConnectionName } from '@hddcoin-network/api';
import { useGetWalletConnectionsQuery } from '@hddcoin-network/api-react';
import { Card, FormatBytes, Loading, Table } from '@hddcoin-network/core';
