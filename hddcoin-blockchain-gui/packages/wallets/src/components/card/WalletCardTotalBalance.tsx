import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@hddcoin-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@hddcoin-network/core';
