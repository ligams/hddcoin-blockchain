import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@hddcoin-network/api-react';
import { Flex, Loading, truncateValue, useColorModeValue } from '@hddcoin-network/core';
import { Reload } from '@hddcoin-network/icons';
