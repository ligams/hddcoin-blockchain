import { TransactionType } from '@hddcoin-network/api';
import type { Transaction } from '@hddcoin-network/api';
import { useGetAutoClaimQuery } from '@hddcoin-network/api-react';
import { useTrans, Button } from '@hddcoin-network/core';
    ...
    if (timeLeft > 0) {
      ...
      onClick = () =>
        setClawbackClaimTransactionDialogProps({
          ...
          amountInByte: transactionRow.amount,
          fromOrTo: 'from',
