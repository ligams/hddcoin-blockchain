import type { CATToken } from '@hddcoin-network/api';
import { SyncingStatus } from '@hddcoin-network/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@hddcoin-network/api-react';
import { Back, Flex, Loading, useShowError } from '@hddcoin-network/core';
