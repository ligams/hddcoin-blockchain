...
import { useSetCATNameMutation, useGetCatListQuery } from '@hddcoin-network/api-react';
import { Flex, Loading, MenuItem, useOpenDialog } from '@hddcoin-network/core';
import { Offers as OffersIcon } from '@hddcoin-network/icons';
