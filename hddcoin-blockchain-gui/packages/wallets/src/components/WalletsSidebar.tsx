...
import { useGetLoggedInFingerprintQuery, useGetPrivateKeyQuery, useGetWalletsQuery } from '@hddcoin-network/api-react';
import {
  Flex,
  CardListItem,
  useOpenDialog,
...
export default function WalletsSidebar() {
  ...
  function handleOpenBlogPost() {
    openExternal('https://www.hddcoin.org/cat2blog');
  }
    ...
    openDialog(
      <WalletEmptyDialog>
        <ContentStyled>
          ...
          <ActionsStyled>
            <Flex gap={3} flexDirection="column" width="100%">
              <Button
                ...
                size="large"
                onClick={() =>
                  openExternal(`https://cat1.hddcoin.org/#publicKey=${privateKey.pk}&fingerprint=${fingerprint}`)
                }
          ...
          <Link target="_blank" href="https://www.hddcoin.org/download/">
