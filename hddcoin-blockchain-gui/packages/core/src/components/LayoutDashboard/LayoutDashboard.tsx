import { useGetLoggedInFingerprintQuery, useGetKeyQuery, useFingerprintSettings } from '@hddcoin-network/api-react';
import { Exit as ExitIcon } from '@hddcoin-network/icons';
