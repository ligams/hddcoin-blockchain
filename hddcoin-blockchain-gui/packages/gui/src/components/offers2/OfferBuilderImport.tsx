...
import { useGetOfferSummaryMutation } from '@hddcoin-network/api-react';
import { Dropzone, Flex, useSerializedNavigationState, useShowError } from '@hddcoin-network/core';
