import { useCreateNewPoolWalletMutation } from '@hddcoin-network/api-react';
import { Flex, Suspender } from '@hddcoin-network/core';
  ...
  return (
    <>
      ...
      <PlotNFTSelectPool
        ...
        description={
          <Trans>
            Join a pool and get consistent HDD farming rewards. The average returns are the same, but it is much less
