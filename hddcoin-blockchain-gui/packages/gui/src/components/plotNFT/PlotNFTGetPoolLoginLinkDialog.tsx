import type { PlotNFT, PlotNFTExternal } from '@hddcoin-network/api';
import { useGetPoolLoginLinkQuery } from '@hddcoin-network/api-react';
import { Button, CopyToClipboard, Flex, Link, Loading } from '@hddcoin-network/core';
