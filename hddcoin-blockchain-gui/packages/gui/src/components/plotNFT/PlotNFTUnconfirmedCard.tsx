import type { UnconfirmedPlotNFT } from '@hddcoin-network/api';
import { useGetTransactionQuery } from '@hddcoin-network/api-react';
import { Flex, Link, Loading } from '@hddcoin-network/core';
