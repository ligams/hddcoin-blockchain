import { useDeleteUnconfirmedTransactionsMutation } from '@hddcoin-network/api-react';
import {
  Button,
  TooltipTypography,
  Flex,
...
import { Plot as PlotIcon } from '@hddcoin-network/icons';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: <UnitFormat value={byteToHDDcoinLocaleString(balance)} state={State.SUCCESS} />,
    },
    {
      key: 'plotsCount',
