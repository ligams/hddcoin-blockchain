import { Button, CopyToClipboard, Flex, Link, Loading, TextField, Form } from '@hddcoin-network/core';
            ...
            {loading ? (
              ...
              <Flex flexDirection="column" gap={2}>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    These are the instructions for how the farmer wants to get paid. By default this will be an HDD
