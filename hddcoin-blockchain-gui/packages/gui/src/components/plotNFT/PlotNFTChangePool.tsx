import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@hddcoin-network/api-react';
import { Flex, State, Loading, StateTypography } from '@hddcoin-network/core';
