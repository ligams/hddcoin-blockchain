import type { Connection } from '@hddcoin-network/api';
import { ServiceName } from '@hddcoin-network/api';
import { useGetFarmerFullNodeConnectionsQuery, useService } from '@hddcoin-network/api-react';
import { Table, Card, FormatBytes, FormatConnectionStatus } from '@hddcoin-network/core';
