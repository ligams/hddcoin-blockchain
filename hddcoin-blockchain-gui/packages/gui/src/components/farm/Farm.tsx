import { useGetHarvesterConnectionsQuery, useGetTotalHarvestersSummaryQuery } from '@hddcoin-network/api-react';
import { AdvancedOptions, Flex, LayoutDashboardSub, Loading } from '@hddcoin-network/core';
