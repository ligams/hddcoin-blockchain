import { Connection } from '@hddcoin-network/api';
import { useGetFullNodeConnectionsQuery } from '@hddcoin-network/api-react';
import { Card, FormatBytes, FormatLargeNumber, IconButton, Loading, Table, useOpenDialog } from '@hddcoin-network/core';
