import { Button, Flex, Logo, Card, useMode, Mode } from '@hddcoin-network/core';
import { Farming as FarmingIcon } from '@hddcoin-network/icons';
                  ...
                  <Flex flexDirection="column" gap={1.5} flexGrow={1}>
                    <Flex gap={1} alignItems="center">
                      ...
                      <Typography variant="body2">
                        <Trans>Store and Send HDD</Trans>
                      </Typography>
                    </Flex>
                    <Flex gap={1} alignItems="center">
                      <StyledCheckIcon color="primary" />
