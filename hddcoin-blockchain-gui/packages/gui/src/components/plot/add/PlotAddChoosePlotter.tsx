import { defaultPlotter, PlotterName } from '@hddcoin-network/api';
import type { Plotter, PlotterMap } from '@hddcoin-network/api';
import { useGetPlottersQuery } from '@hddcoin-network/api-react';
import { CardStep, Select, StateColor } from '@hddcoin-network/core';
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          the default HDDcoin Proof of Space plotter. If unsure, use the default HDDcoin Proof of Space plotter.
        </Trans>
      </Typography>
