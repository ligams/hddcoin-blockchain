...
import { NFTInfo } from '@hddcoin-network/api';
...
import AppIcon from '../assets/img/hddcoin64x64.png';
...
// Set the userData directory to its location within HDDCOIN_ROOT/gui
setUserDataDir();
