import { OfferCoinOfInterest, OfferSummaryRecord } from '@hddcoin-network/api';
import { useGetOffersCountQuery, useGetAllOffersQuery } from '@hddcoin-network/api-react';
