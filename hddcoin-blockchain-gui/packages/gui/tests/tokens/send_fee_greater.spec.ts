...
test('Confirm that User cannot send a THDD fee greater then in Wallet', async () => {
  ...
  await page.locator('text=Fee *THDD >> input[type="text"]').fill('10');
  ...
  await expect(page.locator('text=Pending Change0 THDD')).toBeVisible();
});
