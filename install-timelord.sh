...
CHIAVDF_VERSION=$(python -c 'import os; os.environ["HDDCOIN_SKIP_SETUP"] = "1"; from setup import dependencies; t = [_ for _ in dependencies if _.startswith("chiavdf")][0]; print(t)')
